...
if st.session_state.get("show_add_form", False):
    with st.container(border=True):
        st.markdown("**➕ 종목 추가**")
        c1, c2, c3, c4, c5, c6, c7 = st.columns([1.5, 1.5, 1, 1.5, 1, 1, 1])
        ...
        c6.markdown("<div style='font-size:12px;color:#555;margin-bottom:28px;'>ETF 여부</div>",
                    unsafe_allow_html=True)
        f_is_etf = c6.checkbox("ETF", value=False, key="f_is_etf",
